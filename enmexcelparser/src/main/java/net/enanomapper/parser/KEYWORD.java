...
public enum KEYWORD {
	...
	REFERENCE_SUBSTANCE_UUID, SUBSTANCE_UUID, ASSAY_UUID, OWNER_NAME, OWNER_UUID, SUBSTANCE_TYPE, FUNCTION {
		@Override
	...
	SOURCE_COMBINATION, COMBINATION_SEPARATOR, IS_ARRAY, TRIM_ARRAY, DATA_INTERPRETATION, DATE_FORMAT, COLUMN_INDEX, COLUMN_INDICES, COLUMN_NAME, ROW_INDEX, ROW_INDICES, ROW_NAME, JSON_REPOSITORY_KEY, RELIABILITY_IS_ROBUST_STUDY, RELIABILITY_IS_USED_FOR_CLASSIFICATION, RELIABILITY_IS_USED_FOR_MSDS, RELIABILITY_PURPOSE_FLAG, RELIABILITY_STUDY_RESULT_TYPE, RELIABILITY_VALUE, INTERPRETATION_RESULT, INTERPRETATION_CRITERIA, EFFECTS {
