...
public class CliOptions {
	public enum _commandmode {csv,nanowiki,parse,params,help,json,html};
	...
	protected _commandmode subcommand = _commandmode.parse;
	...
	protected void setConfig(String config) {
		...
		if (config==null) {
			...
			System.err.println("Config file not specified or do not exist, using default "+ 
					getClass().getClassLoader().getResource("config/enm.properties"));
		}		
	}
	...
	*/
	...
	protected static void printHelp(Options options,String message) {
	    ...
	    formatter.printHelp( eNMParser.class.getName(), options );
				 ...
				 if (runExample) {
					 ...
					 if (node!=null && node.asBoolean()) {
						 ...
						 try {
							 ...
							 options.parse(args);
							 eNMParser cli = new eNMParser(options);
